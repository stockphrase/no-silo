...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.2a7682bdb24fff309da16919f25c14b42dd407623e55d9f095cb90250faaa929.js',function(){input.required=false;search();});}
