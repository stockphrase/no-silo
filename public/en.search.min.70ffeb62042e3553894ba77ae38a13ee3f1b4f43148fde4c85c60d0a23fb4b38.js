...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.d2ff5a4d4d4914af88a30363af9e603a4509cae6e529780cac538cfdb6eb10be.js',function(){input.required=false;search();});}
