...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.306415f6f33781cffce3c4b4a057c3802ecd19283018092d4db0b5cd07ef9e16.js',function(){input.required=false;search();});}
