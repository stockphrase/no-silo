...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.1a276056e94bd8baad09fbc68ba7bd5230a72070f4048bc039438adc2cd34bca.js',function(){input.required=false;search();});}
