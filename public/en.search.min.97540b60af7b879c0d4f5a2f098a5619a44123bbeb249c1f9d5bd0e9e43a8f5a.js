...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.58ddf5e79aec4eafeefaba407b76194be55680f931403a0ca8c6be79601b717c.js',function(){input.required=false;search();});}
