...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.740c68778739fd2665bcca30d4ee2de8e288b9d26e3db352049818f1db0bb358.js',function(){input.required=false;search();});}
