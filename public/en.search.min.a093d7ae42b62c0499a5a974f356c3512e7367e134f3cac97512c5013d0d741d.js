...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.8342fc32099aa8be78162254ac413d4dbac52f26afcedd38f49742f39b5f56df.js',function(){input.required=false;search();});}
