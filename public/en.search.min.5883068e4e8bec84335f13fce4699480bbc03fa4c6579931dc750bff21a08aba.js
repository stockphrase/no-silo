...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.756b79fc4cdac36f11a678de48853ba081f35192cf885dcb0423e04d2d5ec61f.js',function(){input.required=false;search();});}
