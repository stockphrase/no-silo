...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ae8268b49befdbdbad9febf6c9d4ec3bd686c806ea65a44e8a771d2b31996fc7.js',function(){input.required=false;search();});}
