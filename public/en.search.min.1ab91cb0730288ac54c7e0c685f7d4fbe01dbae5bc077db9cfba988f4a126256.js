...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.085583f306fec9ddf09cc04d9a7f2d7e83f4e1973bfd3c4e601bbc32a1226df5.js',function(){input.required=false;search();});}
