...
*The problem is that it just doesn't work that way*. 

The narrative of the research process in books is misleading; it presents an idealized and simplified description of how a project comes to be, develops, and concludes. The truth of the matter is that academic research is rarely a logical, linear operation. And a list of steps can never fully prepare a researcher for the twists and turns and setbacks of surprises of true inquiry. The truth of the matter is that research *is a messy, recursive, and frequently frustrating process*. But it is also a surprising, exhilarating, and fulfilling one. When students try research for themselves and experience difficulty and confusion instead of an orderly march to success, they often feel as if they aren't good enough or smart enough to do research. So if you feel confused and overwhelmed at moments, you should know that is perfectly normal and you're doing just fine. 
...
With that out of the way, what I describe below presents a set of steps virtually identical to what I've just criticized. The difference is that I won't pretend that following a list of procedures will somehow magically produce an exemplary research essay. That requires a lot of hard work, creativity, inspiration, and help from others that is difficult to capture in a checklist. 

Research, like many things in life, is something that you must do in order to learn and practice in order to improve. Mistakes and confusion are great teachers if we can be patient with them---they help reveal the limits of our knowledge and the horizon of our skills. Over time, and with experience, you will gain better research instincts. But it is nice when there is someone you can ask for help when things get really tough. I am honored to be your person here at the beginning. And there are [many others at the library who are happy to help](https://researchguides.dartmouth.edu/subjectlibrarians) who have specialized training that far exceeds my own.  
