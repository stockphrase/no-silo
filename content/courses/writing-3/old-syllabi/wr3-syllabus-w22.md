...
{{< hint note >}} 
<span style="color: var(--due)"><i class="far fa-dot-circle"></i> **NOTE: All assignments must be completed to pass the course.** </span>
{{< /hint >}} 
...
- [<i class="far fa-clock"></i>]() Tuesday, 1.18 | X-hour | 
- [<i class="far fa-clock"></i>]() Tuesday, 1.18 | X-hour | 
